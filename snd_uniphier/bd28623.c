...
static int bd28623_codec_probe(struct snd_soc_codec *component)
{
	struct bd28623_priv *bd = snd_soc_codec_get_drvdata(component);
	int ret;
...
static int bd28623_codec_remove(struct snd_soc_codec *component)
{
	struct bd28623_priv *bd = snd_soc_codec_get_drvdata(component);
...
static int bd28623_codec_suspend(struct snd_soc_codec *component)
{
	struct bd28623_priv *bd = snd_soc_codec_get_drvdata(component);
...
static int bd28623_codec_resume(struct snd_soc_codec *component)
{
	struct bd28623_priv *bd = snd_soc_codec_get_drvdata(component);
	int ret;
...
static struct snd_soc_codec_driver soc_codec_bd = {
...
static int bd28623_probe(struct platform_device *pdev)
{
	...
	return snd_soc_register_codec(dev, &soc_codec_bd,
				      &soc_dai_bd, 1);
}
...
static int bd28623_remove(struct platform_device *pdev)
{
	...
	snd_soc_unregister_codec(bd->dev);
